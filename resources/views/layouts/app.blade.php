...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light  shadow-sm "  style="background-color: #486d65">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/mutaeafif') }}">
                    {{-- {{ config('app.name', 'Laravel') }} --}}
                   <h2 style="color: #ffffff">mutaeafif </h2> 
                </a>
