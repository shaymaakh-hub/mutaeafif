...
@extends('layouts.master')
 ...
 <!-- start contributor register -->
     
 <div class="container">
    <div class="row">
        <div class="reg-text">
    <p  class=" col-lg-7">شكرا لختيارك حالة لتبرع لها ,نتمنى ان  تتواصل مع الحالة المحتاجة بشكل مباشر من خلال معلوماته .نرجو كتابة معلوماتك في الاسفل . </p>
        </div></div>
</div>
@if(count($errors)>0)
...
<div class="container">
   <div class="row">
         ...
         <div class="card-body">
            ...
            <form method="post" action="{{route('contributorinfo.store',['id'=>$id])}}" enctype="multipart/form-data"> 
                {{ csrf_field()}}
                   <div class="group">
                  ...
                  <input type="text" name="name" placeholder="أسمك الثلاثي" value="{{ old('name') }}">
                   ...
                   <div class="group">
                      <label class="pad4" for="province"><i class="fas fa-map-marker-alt fa-1x pad"></i>المحافظة</label>
                ...
                <input type="text" name="phone" placeholder="رقم هاتفك" value="{{ old('phone') }}">
                     </div>
                  
                    
                    <div class="group">
                       
                        <button type="submit" class="button mb-2"> ارسال</button>
